...
export function registerGetProjectStatusTool(server: McpServer): RegisteredTool {
  return server.registerTool(
    ...
    {
      description:
        'Get the status of a single Barnacles project by ID: git branch, uncommitted changes, last commit, and stats. Use list_projects first to find the project ID.',
      inputSchema: {
