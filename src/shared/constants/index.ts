...
export const API_ROUTES = {
  ...
  PROJECTS_ADD_BY_PATH: '/api/projects/meta/by-path',
  ...
  SETTINGS_SCAN_DIRECTORIES: '/api/settings/scan-directories',
  ...
  EVENTS: '/api/events',
  EVENTS_COUNTS: '/api/events/counts',
  EVENTS_SERIES: '/api/events/series',
  PORTS: '/api/ports',
